...
function(rift_add_vala target)
  ...
  add_custom_command(
    ...
    COMMAND
    ${CMAKE_INSTALL_PREFIX}/usr/bin/g-ir-compiler ${gir_compiler_flags} ${generate_gir_file}
...
function(rift_add_plugin_vapi2c target)
  ...
  add_custom_command(
    ...
    COMMAND
    ${PROJECT_TOP_DIR}/scripts/util/vapi_to_c.py ${ARGS_VAPI_FILE} --c-file=${dest_c_file} --h-file=${dest_h_file}
    ${plugin_prefix}
    WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
...
function(rift_add_introspection target)
  ...
  # Parse the function arguments
  ##
  set(parse_options NO_UNPREFIXED GENERATE_GI_OVERRIDE)
  ...
  set(INCLUDE_PATHS
    ...
    -I${CMAKE_INSTALL_PREFIX}/usr/include/libpeas-1.0
    -I${CMAKE_INSTALL_PREFIX}/usr/include/gobject-introspection-1.0
    -I${CMAKE_INSTALL_PREFIX}/usr/include/rift/plugins
    -I${CMAKE_INSTALL_PREFIX}/usr/lib/glib-2.0/include
    -I${CMAKE_INSTALL_PREFIX}/usr/include/glib-2.0
    -I${CMAKE_INSTALL_PREFIX}/usr/include/glib-2.0/include)
  ...
  add_custom_command(
    ...
    COMMAND ${CMAKE_INSTALL_PREFIX}/usr/bin/g-ir-scanner 
  ...
  add_custom_command(
    ...
    COMMAND
    ${CMAKE_INSTALL_PREFIX}/usr/bin/vapigen 
    ${GIR_PATHS}
    ${VAPI_DIRS}
    ${PACKAGES}
  ...
  add_custom_command(
    ...
    COMMAND
    ${CMAKE_INSTALL_PREFIX}/usr/bin/g-ir-compiler ${gir_compiler_flags}
    ${GIR_PATHS}
    ${CMAKE_CURRENT_BINARY_DIR}/${ARGS_NAMESPACE}-${ARGS_VERSION}.gir
    ${LIBRARIES}
    --output=${CMAKE_CURRENT_BINARY_DIR}/${ARGS_NAMESPACE}-${ARGS_VERSION}.typelib
  ...
  if(NOT ARGS_GI_PY_OVERRIDE_FILE AND ARGS_GENERATE_GI_OVERRIDE)
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} -E copy
      ${PROJECT_TOP_DIR}/cmake/modules/python_override_template.py
      ${CMAKE_CURRENT_BINARY_DIR}/${ARGS_NAMESPACE}.py
      COMMAND sed -i -e 's/NAMESPACE/${ARGS_NAMESPACE}/g'
      ${CMAKE_CURRENT_BINARY_DIR}/${ARGS_NAMESPACE}.py
      DEPENDS ${PROJECT_TOP_DIR}/cmake/modules/python_override_template.py
      )
  ...
  add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E copy
    ${PROJECT_TOP_DIR}/cmake/modules/lua_override_template.lua
    ${CMAKE_CURRENT_BINARY_DIR}/${ARGS_NAMESPACE}.lua
    COMMAND sed -i -e 's/NAMESPACE/${ARGS_NAMESPACE}/g'
    ${CMAKE_CURRENT_BINARY_DIR}/${ARGS_NAMESPACE}.lua
    DEPENDS ${PROJECT_TOP_DIR}/cmake/modules/lua_override_template.lua
    )
