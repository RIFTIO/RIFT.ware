...
cp -Lrf $source_dir/installed_plugins.txt $dest_dir/.
...
cp -Lrf $source_dir/installed_plugins.txt $bcache_dir/.
...
while read plugin; do
    ...
    cp -Lrf $source_dir/plugins/$plugin/public $dest_dir/plugins/$plugin/.
    cp -Lrf $source_dir/plugins/$plugin/config.json $dest_dir/plugins/$plugin/.
    cp -Lrf $source_dir/plugins/$plugin/routes.js $dest_dir/plugins/$plugin/.
#   cp -Lrp $source_dir/plugins/$plugin/api $dest_dir/plugins/$plugin/.
    mkdir -p $bcache_dir/plugins/$plugin
    cp -Lrf $source_dir/plugins/$plugin/public $bcache_dir/plugins/$plugin/.
    cp -Lrf $source_dir/plugins/$plugin/config.json $bcache_dir/plugins/$plugin/.
    cp -Lrf $source_dir/plugins/$plugin/routes.js $bcache_dir/plugins/$plugin/.
#   cp -Lrp $source_dir/plugins/$plugin/api $bcache_dir/plugins/$plugin/.
done < $source_dir/installed_plugins.txt
