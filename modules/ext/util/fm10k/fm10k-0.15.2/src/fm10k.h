...
#define FM10K_MAX_JUMBO_FRAME_SIZE	15346	/* Maximum supported size 15K */
...
#define FM10K_DEFAULT_RX_WORK	 256
...
#if MAX_SKB_FRAGS < 8
#define FM10K_RX_BUFSZ	ALIGN(FM10K_MAX_JUMBO_FRAME_SIZE / MAX_SKB_FRAGS, 1024)
#else
...
#define FM10K_UIO_REGISTERED			(u32)(1 << 5)
#define FM10K_FLAG_IES_MODE			(u32)(1 << 6)
#define FM10K_FLAG_TX_TS_ENABLED		(u32)(1 << 7)
	int xcast_mode;
...
/* Param */
void fm10k_check_options(struct fm10k_intfc *interface);
