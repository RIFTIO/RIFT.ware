...
def bzr_version_summary(path):
    ...
    import bzrwlib.ui
    bzrwlib.ui.ui_factory = bzrwlib.ui.make_ui_for_terminal(
        sys.stdin, sys.stdout, sys.stderr)
    from bzrwlib import branch, osutils, workingtree
    from bzrwlib.plugin import load_plugins
    load_plugins()
    ...
    try:
        from bzrwlib.plugins.git.object_store import get_object_store
    except ImportError:
        # No git plugin
        ret = "BZR-%d" % revno
    else:
