...
static gboolean vala_switch_statement_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	labelset = _tmp53_;
	{
		...
		while (TRUE) {
			...
			ValaSwitchSection* _tmp65_ = NULL;
			ValaCodeContext* _tmp66_ = NULL;
			ValaSwitchSection* _tmp114_ = NULL;
			...
			vala_code_node_check ((ValaCodeNode*) _tmp65_, _tmp66_);
			{
				...
				ValaSwitchSection* _tmp67_ = NULL;
