			...
			if (_tmp15_ != NULL) {
				{
					...
					i = 0;
					{
						...
						while (TRUE) {
							...
							gint _tmp19_ = 0;
							ValaStatementList* _tmp20_ = NULL;
							gint _tmp21_ = 0;
							gint _tmp22_ = 0;
	...
	g_return_if_fail (new_stmt != NULL);
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				ValaStatementList* _tmp12_ = NULL;
				_tmp1_ = _tmp0_;
				if (!_tmp1_) {
					gint _tmp2_ = 0;
					_tmp2_ = i;
				...
				if (_tmp12_ != NULL) {
					{
						...
						j = 0;
						{
							...
							while (TRUE) {
								...
								gint _tmp16_ = 0;
								ValaStatementList* _tmp17_ = NULL;
								gint _tmp18_ = 0;
								gint _tmp19_ = 0;
								ValaStatementList* _tmp20_ = NULL;
								gint _tmp21_ = 0;
								...
								if (_tmp25_) {
									ValaStatementList* _tmp26_ = NULL;
									gint _tmp27_ = 0;
