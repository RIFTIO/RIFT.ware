...
*                                                                   *
*********************************************************************/
static xpath_result_t* parse_expr(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    status_t  *res);

static xpath_result_t* boolean_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res );

static xpath_result_t* ceiling_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* concat_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* contains_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* count_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* current_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* false_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* floor_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* id_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* lang_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* last_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* local_name_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* namespace_uri_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* name_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* normalize_space_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* not_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* number_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* position_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* round_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* starts_with_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* string_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* string_length_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* substring_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* substring_after_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* substring_before_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* sum_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* translate_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* true_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* module_loaded_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);

static xpath_result_t* feature_enabled_fn(
    struct ncx_instance_t_ *instance,
    xpath_pcb_t *pcb,
    dlq_hdr_t *parmQ,
    status_t *res);
...
*********************************************************************/
static status_t
    check_instance_result (ncx_instance_t *instance,
                           xpath_pcb_t *pcb,
                           xpath_result_t *result)
{
    ...
    if (result->restype != XP_RT_NODESET) {
        ...
        nodecount = dlq_count(instance, &result->r.nodeQ);
        ...
        if (nodecount > 1) {
            ...
            if (btyp == NCX_BT_INSTANCE_ID ||
                ...
                constrained =
                    typ_get_constrained
                    (instance, obj_get_ctypdef(instance, contextval->obj));
            } else {
                constrained = TRUE;
            }
...
*********************************************************************/
static boolean
    stringify_walker_fn (ncx_instance_t *instance,
                         val_value_t *val,
                         void *cookie1,
                         void *cookie2)
{
    ...
    if (typ_is_string(useval->btyp)) {
        cnt = xml_strlen(instance, VAL_STR(useval));
        if (parms->buffer) {
        ...
        if (parms->buffer) {
            if (parms->buffpos+cnt+2 < parms->buffsize) {
                ...
                res = val_sprintf_simval_nc
                    (instance, &parms->buffer[parms->buffpos], useval, &cnt);
                if (res != NO_ERR) {
                    parms->res = res;
                    return FALSE;
                }
...
*********************************************************************/
static xpath_resnode_t *
    find_resnode_slow (ncx_instance_t *instance,
                       xpath_pcb_t *pcb,
                       dlq_hdr_t *resultQ,
                       xmlns_id_t nsid,
                       const xmlChar *name)
{
    ...
    for (resnode = (xpath_resnode_t *)dlq_firstEntry(instance, resultQ);
        ...
        if (pcb->val) {
            if (nsid && (nsid != val_get_nsid(instance, resnode->node.valptr))) {
                continue;
            }
            if (!xml_strcmp(instance, name, resnode->node.valptr->name)) {
                return resnode;
            }
        } else {
            if (nsid && (nsid != obj_get_nsid(instance, resnode->node.objptr))) {
                continue;
            }
            if (!xml_strcmp(instance,
                            name,
                            obj_get_name(instance, resnode->node.objptr))) {
                return resnode;
            }
        }
    }
...
*********************************************************************/
static void
    set_nodeset_dblslash (ncx_instance_t *instance,
                          xpath_pcb_t *pcb,
                          xpath_result_t *result)
{
    xpath_resnode_t        *resnode;
...
*********************************************************************/
static status_t
    set_nodeset_self (ncx_instance_t *instance,
                      xpath_pcb_t *pcb,
                      xpath_result_t *result,
                      xmlns_id_t nsid,
                      const xmlChar *name,
...
*********************************************************************/
static status_t
    set_nodeset_parent (ncx_instance_t *instance,
                        xpath_pcb_t *pcb,
                        xpath_result_t *result,
                        xmlns_id_t nsid,
                        const xmlChar *name)
...
*********************************************************************/
static status_t
    set_nodeset_child (ncx_instance_t *instance,
                       xpath_pcb_t *pcb,
                       xpath_result_t *result,
...
*********************************************************************/
static status_t
    set_nodeset_pfaxis (ncx_instance_t *instance,
                        xpath_pcb_t *pcb,
                        xpath_result_t *result,
                        xmlns_id_t  nsid,
                        const xmlChar *name,
...
*********************************************************************/
static status_t
    set_nodeset_ancestor (ncx_instance_t *instance,
                          xpath_pcb_t *pcb,
                          xpath_result_t *result,
                          xmlns_id_t  nsid,
                          const xmlChar *name,
    ...
    while (!dlq_empty(instance, &result->r.nodeQ) && res == NO_ERR) {
        ...
        if (walkerparms.res != NO_ERR) {
            ...
            if (walkerparms.res != NO_ERR) {
                ...
                res = set_nodeset_ancestor(instance,
                                           pcb,
                                           dummy,
                                           nsid,
                                           name,
...
*********************************************************************/
static status_t
    parse_node_test (ncx_instance_t *instance,
                     xpath_pcb_t *pcb,
                     ncx_xpath_axis_t axis,
                     xpath_result_t **result)
{
    ...
    case XP_AX_CHILD:
        ...
        if (res == NO_ERR) {
            res = set_nodeset_child(instance,
                                    pcb,
                                    *result,
                                    nsid,
                                    name,
    ...
    case XP_AX_PRECEDING_SIBLING:
        ...
        if (res == NO_ERR) {
            res = set_nodeset_pfaxis(instance,
                                     pcb,
                                     *result,
                                     nsid,
                                     name,
    ...
    case XP_AX_PARENT:
        ...
        if (res == NO_ERR) {
            res = set_nodeset_parent(instance,
                                     pcb,
                                     *result,
                                     nsid,
                                     name);
...
*********************************************************************/
static status_t
    parse_predicate (ncx_instance_t *instance,
                     xpath_pcb_t *pcb,
                     xpath_result_t **result)
{
    ...
    if (pcb->val || pcb->obj) {
        ...
        if (!contextset) {
            ...
            if (dlq_empty(instance, &contextset->r.nodeQ)) {
                ...
                val1 = parse_expr(instance, pcb, &res);
                if (res == NO_ERR) {
...
*********************************************************************/
static status_t
    parse_step (ncx_instance_t *instance,
                xpath_pcb_t *pcb,
                xpath_result_t **result)
{
    const xmlChar    *nextval;
    ...
    if (nexttyp == TK_TT_DBLFSLASH) {
        ...
        set_nodeset_dblslash(instance, pcb, *result);
    ...
    res = parse_node_test(instance, pcb, axis, result);
    if (res == NO_ERR) {
        nexttyp = tk_next_typ(instance, pcb->tkc);
        while (nexttyp == TK_TT_LBRACK && res==NO_ERR) {
            res = parse_predicate(instance, pcb, result);
            nexttyp = tk_next_typ(instance, pcb->tkc);
        }
    }
...
*********************************************************************/
static xpath_result_t *
    parse_location_path (ncx_instance_t *instance,
                         xpath_pcb_t *pcb,
                         xpath_result_t *result,
                         status_t *res)
{
    ...
    while (!done && *res == NO_ERR) {
        *res = parse_step(instance, pcb, &val1);
        if (*res == NO_ERR) {
            nexttyp = tk_next_typ(instance, pcb->tkc);
...
*********************************************************************/
static xpath_result_t *
    parse_function_call (ncx_instance_t *instance,
                         xpath_pcb_t *pcb,
                         status_t *res)
{
...
*********************************************************************/
static xpath_result_t *
    parse_primary_expr (ncx_instance_t *instance,
                        xpath_pcb_t *pcb,
                        status_t *res)
{
    xpath_result_t         *val1;
    ...
    case TK_TT_TSTRING:                    /* NCName string */
        ...
        if (nexttyp == TK_TT_LPAREN) {
            val1 = parse_function_call(instance, pcb, res);
        } else {
            *res = SET_ERROR(instance, ERR_INTERNAL_VAL);
        }
        break;
...
*********************************************************************/
static xpath_result_t *
    parse_filter_expr (ncx_instance_t *instance,
                       xpath_pcb_t *pcb,
                       status_t *res)
{
    ...
    val1 = parse_primary_expr(instance, pcb, res);
    if (*res != NO_ERR) {
        return val1;
    }
    ...
    if (val1) {
        while (nexttyp == TK_TT_LBRACK && *res==NO_ERR) {
            *res = parse_predicate(instance, pcb, &val1);
            nexttyp = tk_next_typ(instance, pcb->tkc);
        }
        ...
        if (dummy) {
            while (nexttyp == TK_TT_LBRACK && *res==NO_ERR) {
                *res = parse_predicate(instance, pcb, &dummy);
                nexttyp = tk_next_typ(instance, pcb->tkc);
            }
            free_result(instance, pcb, dummy);
        } else {
...
*********************************************************************/
static xpath_result_t *
    parse_path_expr (ncx_instance_t *instance,
                     xpath_pcb_t *pcb,
                     status_t *res)
{
    xpath_result_t  *val1, *val2;
    ...
    case TK_TT_MSTRING:          /* rel, step, node, QName */
        return parse_location_path(instance, pcb, NULL, res);
    case TK_TT_TSTRING:
    ...
    val1 = parse_filter_expr(instance, pcb, res);
    ...
    if (*res == NO_ERR) {
        ...
        if (curop != XP_EXOP_NONE) {
            val2 = parse_location_path(instance, pcb, val1, res);
        } else {
            val2 = val1;
        }
        val1 = NULL;
...
*********************************************************************/
static xpath_result_t *
    parse_union_expr (ncx_instance_t *instance,
                      xpath_pcb_t *pcb,
                      status_t *res)
{
    xpath_result_t  *val1, *val2;
    ...
    while (!done && *res == NO_ERR) {
        val1 = parse_path_expr(instance, pcb, res);
...
*********************************************************************/
static xpath_result_t *
    parse_unary_expr (ncx_instance_t *instance,
                      xpath_pcb_t *pcb,
                      status_t *res)
{
    ...
    val1 = parse_union_expr(instance, pcb, res);
...
*********************************************************************/
static xpath_result_t *
    parse_multiplicative_expr (ncx_instance_t *instance,
                               xpath_pcb_t *pcb,
                               status_t *res)
{
    ...
    while (!done && *res == NO_ERR) {
        val1 = parse_unary_expr(instance, pcb, res);
...
*********************************************************************/
static xpath_result_t *
    parse_additive_expr (ncx_instance_t *instance,
                           xpath_pcb_t *pcb,
                           status_t *res)
{
    xpath_result_t  *val1, *val2, *result;
    ...
    while (!done && *res == NO_ERR) {
        val1 = parse_multiplicative_expr(instance, pcb, res);
...
*********************************************************************/
static xpath_result_t *
    parse_relational_expr (ncx_instance_t *instance,
                           xpath_pcb_t *pcb,
                           status_t *res)
{
    xpath_result_t  *val1, *val2, *result;
    ...
    while (!done && *res == NO_ERR) {
        val1 = parse_additive_expr(instance, pcb, res);
...
*********************************************************************/
static xpath_result_t *
    parse_equality_expr (ncx_instance_t *instance,
                         xpath_pcb_t *pcb,
                         status_t *res)
{
    xpath_result_t  *val1, *val2, *result;
    ...
    while (!done && *res == NO_ERR) {
        val1 = parse_relational_expr(instance, pcb, res);
...
*********************************************************************/
static xpath_result_t *
    parse_and_expr (ncx_instance_t *instance,
                    xpath_pcb_t *pcb,
                    status_t *res)
{
    xpath_result_t  *val1, *val2, *result;
    ...
    while (!done && *res == NO_ERR) {
        val1 = parse_equality_expr(instance, pcb, res);
...
*********************************************************************/
static xpath_result_t *
    parse_or_expr (ncx_instance_t *instance,
                   xpath_pcb_t *pcb,
                   status_t *res)
{
    xpath_result_t  *val1, *val2, *result;
    ...
    while (!done && *res == NO_ERR) {
        val1 = parse_and_expr(instance, pcb, res);
...
*********************************************************************/
static xpath_result_t *
    parse_expr (ncx_instance_t *instance,
                xpath_pcb_t *pcb,
                status_t  *res)
{

    return parse_or_expr(instance, pcb, res);
...
static obj_template_t *
    get_context_objnode (ncx_instance_t *instance, obj_template_t *obj)
{
    boolean done;
...
*********************************************************************/
status_t
    xpath1_parse_expr (ncx_instance_t *instance,
                       tk_chain_t *tkc,
                       ncx_module_t *mod,
                       xpath_pcb_t *pcb,
                       xpath_source_t source)
{
    ...
    if (pcb->source == XP_SRC_INSTANCEID) {
        ...
        result = parse_location_path(instance, pcb, NULL, &pcb->parseres);
    } else {
        result = parse_expr(instance, pcb, &pcb->parseres);
    }
...
*********************************************************************/
status_t
    xpath1_validate_expr_ex (ncx_instance_t *instance,
                             ncx_module_t *mod,
                             obj_template_t *obj,
                             xpath_pcb_t *pcb,
                             boolean missing_is_error)
{
    ...
    if (pcb->source == XP_SRC_YANG && obj_is_config(instance, obj)) {
    ...
    pcb->context.node.objptr = get_context_objnode(instance, obj);
     ...
     */
    if (pcb->source == XP_SRC_INSTANCEID) {
        result = parse_location_path(instance, pcb, NULL, &pcb->validateres);
    } else {
        result = parse_expr(instance, pcb, &pcb->validateres);
    }

    if (result) {
        if (LOGDEBUG3) {
            dump_result(instance, pcb, result, "validate_expr");
        }
...
*********************************************************************/
status_t
    xpath1_validate_expr (ncx_instance_t *instance,
                          ncx_module_t *mod,
                          obj_template_t *obj,
                          xpath_pcb_t *pcb)
{
    return xpath1_validate_expr_ex(instance, mod, obj, pcb, TRUE);
}
...
*********************************************************************/
xpath_result_t *
    xpath1_eval_expr (ncx_instance_t *instance,
                      xpath_pcb_t *pcb,
                      val_value_t *val,
                      val_value_t *docroot,
                      boolean logerrors,
                      ...
                      status_t *res)
{
    ...
    if (pcb->tkc) {
        ...
        pcb->tkc = tk_tokenize_xpath_string(instance, NULL, pcb->exprstr, 1, 1, res);
        if (!pcb->tkc || *res != NO_ERR) {
            if (logerrors) {
    ...
    if (pcb->source == XP_SRC_INSTANCEID) {
        result = parse_location_path(instance, pcb, NULL, &pcb->valueres);
    } else {
        result = parse_expr(instance, pcb, &pcb->valueres);
    }
    ...
    if (LOGDEBUG3 && result) {
        dump_result(instance, pcb, result, "eval_expr");
    }
...
*********************************************************************/
xpath_result_t *
    xpath1_eval_xmlexpr (ncx_instance_t *instance,
                         ...
                         status_t *res)
{
    ...
    *res = NO_ERR;
    ...
    if (configonly ||
        (pcb->source == XP_SRC_YANG && val && obj_is_config(instance, val->obj))) {
        pcb->flags |= XP_FL_CONFIGONLY;
    }
        ...
        if (myres == NO_ERR) {
            ...
            if (pcb->logerrors) {
                log_error(instance,
                          ...
                          pcb->exprstr);
                ncx_print_errormsg(instance, pcb->tkc, pcb->tkerr.mod, pcb->valueres);
            }
        }
    }
    ...
    if (val && pcb->valueres == NO_ERR && result &&
        ...
        pcb->valueres = check_instance_result(instance, pcb, result);
    }

    *res = pcb->valueres;

    if (LOGDEBUG3 && result) {
        dump_result(instance, pcb, result, "eval_xmlexpr");
    }
...
*********************************************************************/
void
    xpath1_prune_nodeset (ncx_instance_t *instance,
                          xpath_pcb_t *pcb,
                          xpath_result_t *result)
{
    ...
    for (resnode = (xpath_resnode_t *)
        ...
        nextnode = (xpath_resnode_t *)dlq_nextEntry(instance, resnode);
        ...
        if (xpath1_check_node_exists(instance,
            ...
            log_debug2(instance,
                       ...
                       val_get_mod_name(instance, resnode->node.valptr),
                       resnode->node.valptr->name);
            free_resnode(instance, pcb, resnode);
        } else {
            if (nextnode) {
                dlq_insertAhead(instance, resnode, nextnode);
            } else {
                dlq_enque(instance, resnode, &result->r.nodeQ);
            }
        }
...
*********************************************************************/
boolean
    xpath1_check_node_exists (ncx_instance_t *instance,
                              xpath_pcb_t *pcb,
                              dlq_hdr_t *resultQ,
                              const val_value_t *val)
{
    ...
    while (val) {
        if (find_resnode(instance, pcb, resultQ, val)) {
            return TRUE;
        }
...
*********************************************************************/
boolean
    xpath1_check_node_exists_slow (ncx_instance_t *instance,
                                   xpath_pcb_t *pcb,
                                   dlq_hdr_t *resultQ,
                                   const val_value_t *val)
{
...
*********************************************************************/
boolean
    xpath1_check_node_child_exists_slow (ncx_instance_t *instance,
                                         xpath_pcb_t *pcb, 
                                         dlq_hdr_t *resultQ, 
                                         const val_value_t *val)
{
    ...
    for (resnode = (xpath_resnode_t *)dlq_firstEntry(instance, resultQ);
        ...
        if (pcb->val) {
            ...
            for( testval=resnode->node.valptr;
                ...
                if (nsid && (nsid != val_get_nsid(instance, testval))) {
                    continue;
                }
                if (!xml_strcmp(instance, name, testval->name)) {
                    return TRUE;
            ...
            for( testobj=resnode->node.objptr;
                ...
                if (nsid && (nsid != obj_get_nsid(instance, testobj))) {
                    continue;
                }
                if (!xml_strcmp(instance, name, obj_get_name(instance, testobj))) {
                    return TRUE;
...
*********************************************************************/
status_t
    xpath1_stringify_nodeset (ncx_instance_t *instance,
                              xpath_pcb_t *pcb,
                              ...
                              xmlChar **str)
{
    ...
    for (resnode = (xpath_resnode_t *)dlq_firstEntry(instance, &result->r.nodeQ);
        ...
        if (resnode->node.valptr == pcb->val_docroot) {
            ...
            reslevel = val_get_nest_level(instance, resnode->node.valptr);
    ...
    return xpath1_stringify_node(instance, pcb, bestval, str);
...
*********************************************************************/
status_t
    xpath1_stringify_node (ncx_instance_t *instance,
                           xpath_pcb_t *pcb,
                           val_value_t *val,
                           xmlChar **str)
{
    ...
    if (typ_is_simple(instance, val->btyp)) {
        res = val_sprintf_simval_nc(instance, NULL, val, &cnt);
        if (res != NO_ERR) {
            return res;
        }
        *str = m__getMem(instance, cnt+1);
        if (!*str) {
            return ERR_INTERNAL_MEM;
        }
        res = val_sprintf_simval_nc(instance, *str, val, &cnt);
        if (res != NO_ERR) {
            m__free(instance, *str);
            *str = NULL;
            return res;
         ...
         * walkerparms.res
         */
        (void)val_find_all_descendants(instance,
                                       stringify_walker_fn,
                                       pcb,
                                       &walkerparms,
                                       val,
        ...
        walkerparms.buffer = m__getMem(instance, walkerparms.buffpos+2);
        if (!walkerparms.buffer) {
            return ERR_INTERNAL_MEM;
        }
...
*********************************************************************/
boolean
    xpath1_compare_result_to_string (ncx_instance_t *instance,
                                     xpath_pcb_t *pcb,
                                     xpath_result_t *result,
                                     xmlChar *strval,
                                     status_t *res)
{
    ...
    *res = NO_ERR;
    xpath_init_result(instance, &sresult, XP_RT_STRING);
    sresult.r.str = strval;

    retval = compare_results(instance,
                             pcb,
                             result,
                             &sresult,
                             XP_EXOP_EQUAL,
    ...
    sresult.r.str = NULL;
    xpath_clean_result(instance, &sresult);
...
*********************************************************************/
boolean
    xpath1_compare_result_to_number (ncx_instance_t *instance,
                                     xpath_pcb_t *pcb,
                                     xpath_result_t *result,
                                     ncx_num_t *numval,
                                     status_t *res)
{
    ...
    *res = NO_ERR;
    xpath_init_result(instance, &sresult, XP_RT_NUMBER);
    ncx_copy_num(instance, numval, &sresult.r.num, NCX_BT_FLOAT64);
...
*********************************************************************/
boolean
    xpath1_compare_nodeset_results (ncx_instance_t *instance,
                                    xpath_pcb_t *pcb,
                                    ...
                                    status_t *res)
{
    ...
    *res = NO_ERR;
    boolean retval = compare_results(instance, pcb, result1, result2,
                                     XP_EXOP_EQUAL, res);
    return retval;
