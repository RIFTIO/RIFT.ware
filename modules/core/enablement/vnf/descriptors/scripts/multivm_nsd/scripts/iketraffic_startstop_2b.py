...
sleep 2
if {{ $trigger eq "start" }} {{
  send "start vnf ipsec vnf-name pgw_2b vnf-instance 0 service name client0 tunnel-clones name fake count {tun_count} starting-from 1 \r"
  expect "rift# "
  send "start vnf ipsec vnf-name pgw_2b vnf-instance 0 service name client1 tunnel-clones name fake count {tun_count} starting-from 1 \r"
  expect "rift# "
  send "start vnf ipsec vnf-name pgw_2b vnf-instance 0 service name client2 tunnel-clones name fake count {tun_count} starting-from 1 \r"
  expect "rift# "
  send "start vnf ipsec vnf-name pgw_2b vnf-instance 0 service name client3 tunnel-clones name fake count {tun_count} starting-from 1 \r"
}} else {{
  send "stop vnf ipsec vnf-name pgw_2b vnf-instance 0 service name client0 ike-clones name fake count {tun_count} starting-from 1 ike-name name ike2bc \r"  
  expect "rift# "
  send "stop vnf ipsec vnf-name pgw_2b vnf-instance 0 service name client1 ike-clones name fake count {tun_count} starting-from 1 ike-name name ike2bc \r"  
  expect "rift# "
  send "stop vnf ipsec vnf-name pgw_2b vnf-instance 0 service name client2 ike-clones name fake count {tun_count} starting-from 1 ike-name name ike2bc \r"  
  expect "rift# "
  send "stop vnf ipsec vnf-name pgw_2b vnf-instance 0 service name client3 ike-clones name fake count {tun_count} starting-from 1 ike-name name ike2bc \r"  
}}
expect "rift# "
exp_close -i $spid
