...
typedef void (*rwdts_db_get_api_t)(rwdts_kv_handle_t *kv_handle, int db_num, char *key,
...
typedef void (*rwdts_db_hash_get_api_t)(rwdts_kv_handle_t *kv_handle, int db_num,
                                        char *key, int key_len,
                                        void *callbkfn, void *callbk_data);

typedef void (*rwdts_db_hash_get_sernum_api_t)(rwdts_kv_handle_t *kv_handle, int db_num,
                                               char *key, int key_len,
                                               void *callbkfn, void *callbk_data);
...
typedef void (*rwdts_db_hash_exists_api_t)(rwdts_kv_handle_t *kv_handle, int db_num, char *key,
