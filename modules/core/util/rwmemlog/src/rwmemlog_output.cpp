...
static char *rwmemlog_output_buffer_contents_to_string(
  rwmemlog_mgmt_output_t* output );

static char * rwmemlog_output_entry_return_string(
  rwmemlog_mgmt_output_t* output );

static char* rwmemlog_output_instance_return_string(
  rwmemlog_mgmt_output_t* output );
...
char *rwmemlog_instance_to_string(
  rwmemlog_instance_t* instance )
{
  if (!instance) {
    return NULL;
  ...
  output.instance_msg = instance_msg.get();
  rwmemlog_output_instance( &output );
  return (rwmemlog_output_instance_return_string( &output ));
}
...
char *rwmemlog_buffer_to_string(
  rwmemlog_buffer_t* buffer )
{
  if (!buffer || !buffer->header.instance) {
    return NULL;
  ...
  output.buffer_msg = buffer_msg.get();
  rwmemlog_output_buffer( &output );
  return(rwmemlog_output_buffer_contents_to_string( &output ));
}
