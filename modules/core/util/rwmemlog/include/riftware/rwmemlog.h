...
/*****************************************************************************/
/*!
 * @page RwMemlogExPython Python API Examples
 *
 * Access to RW.Memlog tracing is availble through python Gi APIs
 *  - Create RW.Memlog Instance object 
 *  - Get RW.Memlog buffer object 
 *  - Log a plain string into RW.Memlog buffer object 
 *  - Print RW.Memlog buffer object 
 *  - Print the contents of all buffers in a RW.Memlog Instance
 *  - Stringize RW.Memlog buffer object
 *  - Stringize contents of all buffers in a RW.Memlog Instance
 *
 * @code
 *  import gi
 ...
 *
 *  memlog_instance = rwmemlog.instance_new("MemlogSample",0,0) 
 *  memlogbuffer = memlog_instance.get_buffer("MemlogBuffer", 0)
 *  memlogbuffer.buffer_log("This is a sample text for logging inside memlog buffer")
 *
 ...
 *
 *  #stringize buffer contents
 *  buff_str = memlogbuffer.buffer_string()
 *  #stringize instance
 *  memlog_instance.instance_string()
 *
 * @endcode
 *
 */
