...
private:
  ...
  void print_case_choice_header(YangNode*);
  void print_end_case_choice();

private:
  bool first_call_ = true;
  JsonFormatter fmt_;
  YangNode* yn_ = nullptr;
  bool inside_choice_ = false;
  YangNode* curr_choice_ = nullptr;
  YangNode* curr_case_ = nullptr;

  std::stack<YangNode*> choice_stk_;
};
