...
class ParseNodeValueWildcard: public ParseNode
{
public:
  struct clone_visit_t {
    clone_visit_t(const ParseNodeValueWildcard* node)
        : tt(node->wildcard_str_)
    {}
    const char* tt;
  };
  
public:
  ParseNodeValueWildcard(BaseCli& cli, ParseNode* parent);
  ParseNodeValueWildcard(const ParseNodeValueWildcard& other, ParseNode* new_parent);

  ~ParseNodeValueWildcard() override {}

public:
  ParseNodeValueWildcard(const ParseNodeValueWildcard& other) = delete;
  ParseNodeValueWildcard& operator=(const ParseNodeValueWildcard& other) = delete;
