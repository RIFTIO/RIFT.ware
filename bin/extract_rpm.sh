...
{
    rpm --dbpath $rootdir/usr/lib/rpm --relocate /=$rootdir --nodeps -ivh $rpmfile
}
...
# rm -rf $rootdir
mkdir -p $rootdir
rpm --initdb --dbpath $rootdir/usr/lib/rpm
